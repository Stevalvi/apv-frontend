...
const Paciente = ({paciente}) => { // Extraemos ese paciente
    ...
    const formatearFecha = (fecha) => {
        ...
        return new Intl.DateTimeFormat('es-CO', {dateStyle: 'long'}).format(nuevaFecha) // Este código lo que hace es tomar una de las apis más nuevas de javascript, le decimos que queremos usar el formato o idioma de ex-CO osea la fecha en colombia y formateamos la nueva fecha.
    }
