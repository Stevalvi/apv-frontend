...
const CambiarPassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if(Object.values(password).some(campo => campo === '')) { // Si hay al menos un cmapo vacío
                    ...
                    >
                        <div className="my-3">
                            ...
                            <input 
                                ...
                                })} // Tomamos una copia del state y escribimos sobre lo que haya en ese campo del state
                            />
                        </div>
